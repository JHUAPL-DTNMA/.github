...
- An [ADM module file repository](https://github.com/JHUAPL-DTNMA/dtnma-adms) used for change control of offical draft `ietf-*` modules as well as working examples `example-*` and more experimental unofficial modules being tested.
...
- A template-based code generator [CAMP](https://github.com/JHUAPL-DTNMA/dtnma-camp) which generates C11 source for the REFDA and SQL DML source for the REFDM.
